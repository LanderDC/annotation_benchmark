...
\pandocbounded{\includegraphics[keepaspectratio]{../figures/hits_per_method.pdf}}

}

\caption{\label{fig-hits}Bar plot showing the number of proteins that
got a hit per method, before and after filtering the reported results on
e-value \textless{} 1e-3.}
